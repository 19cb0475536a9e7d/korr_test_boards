...
F 0 "U80" H 6000 3250 50  0000 C CNN
...
F 0 "#PWR0417" H 5450 2800 50  0001 C CNN
...
F 0 "#PWR0418" H 5900 3050 50  0001 C CNN
...
F 0 "C348" V 5550 2250 50  0000 C CNN
...
F 0 "#PWR0419" H 5550 2000 50  0001 C CNN
...
F 0 "L17" V 6290 2250 50  0000 C CNN
...
F 0 "#PWR0420" H 8000 4550 50  0001 C CNN
...
F 0 "#PWR0421" H 8000 4700 50  0001 C CNN
...
F 0 "Q171" H 6005 4300 50  0000 L CNN
...
F 0 "R593" V 5800 4450 50  0000 L CNN
...
F 0 "R592" V 5600 4050 50  0000 C CNN
...
F 0 "Q172" H 6005 5200 50  0000 L CNN
...
F 0 "R595" V 5800 5400 50  0000 L CNN
...
F 0 "R594" V 5600 4950 50  0000 C CNN
...
F 0 "R591" V 4950 2900 50  0000 C CNN
...
F 0 "R590" V 4950 2600 50  0000 C CNN
...
F 0 "#PWR0422" H 4800 2500 50  0001 C CNN
...
Wire Wire Line
	4400 3250 5250 3250
$Sheet
S 3050 3150 1350 700 
U 5EB3B9D9
F0 "CurrentSource_B_Sheet" 50
F1 "current_source.sch" 50
F2 "VCC30V" I L 3050 3250 50 
F3 "VCC5V" I L 3050 3350 50 
F4 "PFC_CRNT" O R 4400 3250 50 
F5 "PFC_VCC_ADJ" I L 3050 3650 50 
F6 "PFC_VCC" O R 4400 3350 50 
F7 "PFC_VCC_STOP" I L 3050 3750 50 
F8 "GNDA" U L 3050 3450 50 
$EndSheet
$Sheet
S 3050 2150 1350 700 
U 5EA7880B
F0 "CurrentSource_A_Sheet" 50
F1 "current_source.sch" 50
F2 "VCC30V" I L 3050 2250 50 
F3 "VCC5V" I L 3050 2350 50 
F4 "PFC_CRNT" O R 4400 2250 50 
F5 "PFC_VCC_ADJ" I L 3050 2650 50 
F6 "PFC_VCC" O R 4400 2350 50 
F7 "PFC_VCC_STOP" I L 3050 2750 50 
F8 "GNDA" U L 3050 2450 50 
$EndSheet
Wire Wire Line
	3050 3650 2950 3650
Wire Wire Line
...
F 0 "#PWR0423" H 2600 2200 50  0001 C CNN
F 1 "GNDA" V 2605 2322 50  0000 R CNN
...
F 0 "#PWR0424" H 2650 3200 50  0001 C CNN
F 1 "GNDA" V 2655 3322 50  0000 R CNN
